{
  ...
  parameters: {
    ...
    NSM: { label: "Standard properties layout", cz: "Layout standardních vlastností", value: "DIN4000-81" },
    ...
    D6: { label: "Max rotational speed", cz: "Max. otáčky", value: "1971 1/min" },
    ...
    H21: { label: "Coolant entry", cz: "Vstup chlazení", value: "4" },
    H22: { label: "Coolant exit", cz: "Výstup chlazení", value: "4" },
    H3: { label: "Grade designation", cz: "Třída povlaku", value: "M2BM" },
    H4: { label: "Body material", cz: "Materiál těla", value: "H - solid carbide" },

    J7: { label: "Data chip provision", cz: "Datový čip", value: "0 - bez čipu" }
  }
}
